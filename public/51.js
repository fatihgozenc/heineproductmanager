...
var AmplifyFormField = /** @class */ (function () {
    ...
    AmplifyFormField.prototype.render = function () {
        return (Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "form-field" }, this.label && (Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "form-field-label" }, Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-label", { htmlFor: this.fieldId }, this.label))), this.description && (Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { id: this.fieldId + "-description", class: "form-field-description", "data-test": "form-field-description" }, this.description)), Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "input" }, Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-input", { fieldId: this.fieldId, description: this.description, type: this.type, handleInputChange: this.handleInputChange, placeholder: this.placeholder, name: this.name, value: this.value, inputProps: this.inputProps, disabled: this.disabled }))), this.hint && Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-hint", { id: this.fieldId + "-hint" }, this.hint)));
    };
...
var AmplifyHint = /** @class */ (function () {
    ...
    AmplifyHint.prototype.render = function () {
        return (Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "hint" }, Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", null)));
    };
    return AmplifyHint;
}());
...
var AmplifyLabel = /** @class */ (function () {
    ...
    AmplifyLabel.prototype.render = function () {
        return (Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("label", { class: "label", htmlFor: this.htmlFor }, Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", null)));
    };
    return AmplifyLabel;
}());
