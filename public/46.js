...
var AmplifyCheckbox = /** @class */ (function () {
    ...
    AmplifyCheckbox.prototype.render = function () {
        return (Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "checkbox" }, Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("input", { onClick: this.onClick, type: "checkbox", name: this.name, value: this.value, id: this.fieldId, checked: this.checked, disabled: this.disabled }), Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-label", { htmlFor: this.fieldId }, this.label)));
    };
