...
var AmplifyS3Album = /** @class */ (function () {
    function class_1(hostRef) {
        ...
        this.picker = true;
        /** Picker button text */
        this.pickerText = _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_59947173_js__WEBPACK_IMPORTED_MODULE_4__["T"].PICKER_TEXT);
        this.albumItems = [];
        this.imgArr = {};
    ...
    class_1.prototype.render = function () {
        var _this = this;
        return (Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "album-container" }, Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "grid-row" }, this.albumItems.map(function (item) {
            return (Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "grid-item", key: "key-" + item.key }, Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-s3-image", { key: _this.imgArr[item.key], imgKey: item.key, level: _this.level, path: _this.path, identityId: _this.identityId, track: _this.track, handleOnError: _this.handleOnError, handleOnLoad: _this.handleOnLoad }), Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "img-overlay" })));
        }))), this.picker && Object(_index_a93ff41e_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-picker", { inputHandler: function (e) { return _this.handlePick(e); }, acceptValue: "image/*" })));
    };
    return class_1;
}());
